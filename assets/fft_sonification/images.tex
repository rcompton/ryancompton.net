...
$\displaystyle X_k = \sum_{n=0}^{N-1} x_n e^{\frac{-2 \pi i}{N}nk}
$%
...
$\displaystyle \sum_{n=0}^{N/2-1} x_{2n} e^{\frac{-2 \pi i}{N}(2n)k} + \sum_{n=0}^{N/2-1} x_{2n+1} e^{\frac{-2 \pi i}{N}(2n+1)k}$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay135}%
$\displaystyle X_{\text{even }k} + e^{\frac{-2 \pi i}{N}k} X_{\text{odd }k}$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle x_n = 220.0*2^{\frac{n}{12}}
$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
