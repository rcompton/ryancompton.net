...
for each $$k$$ in $$0, \ldots, N-1$$. Using the [Danielson-Lanczos lemma](http://mathworld.wolfram.com/Danielson-LanczosLemma.html), we split the above sum into its even and odd constituents
...
Here's how it sounds: [fast_fourier_music.wav](/assets/fft_sonification/fast_fourier_music.wav)
